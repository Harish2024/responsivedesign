    ...
    <div class="container">
        <div class="row align-items-end">
            <div class="col text-center">
                Copyright © 2020 Silicon Private Limited, Developed by Harish G.
            </div>
        </div>
    </div>
    <!-- Optional JavaScript -->
...
![output](./static/img/oup1.jpg)

![output](./static/img/oup2.jpg)

![output](./static/img/oup3.jpg)

![output](./static/img/oup4.jpg)

![output](./static/img/oup5.jpg)

![output](./static/img/oup6.jpg)

![output](./static/img/oup7.jpg)

![output](./static/img/oup8.jpg)

![output](./static/img/oup9.jpg)

## CODE VALIDATION REPORT:
![output](./static/img/va.jpg)
